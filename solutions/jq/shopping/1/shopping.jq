...
# template of shopping list JSON object
# { "name": "name of shopping list", "ingredients": [ ...list of ingredients... ], "optional ingredients": [ ...list of ingredients... ] }
# where ingredient is
# { "item": "flour", "amount": { "quantity": 2, "unit": "cup" } }
# and optional argument "substitute" with value of field "item" for some other ingredient
